                    ...
                    <div class="col-md-12">
                            ...
                            <form:form method="POST" modelAttribute="immigrationDetails" action="${immiActionUrl}">
                                ...
                                <spring:bind path="currentStatus">
                                    <div class="form-group col-md-6 ${status.error ? 'has-danger' : ''} snears-vendor-info">
                                        <label class="form-control-label" for="currentStatus">Current Status</label>
                                ...
                                <spring:bind path="receiptNumber">
                                    <div class="form-group col-md-6 ${status.error ? 'has-danger' : ''}">
                                        <label class="form-control-label" for="receiptNumber">Receipt Number</label>
                                        <div class="inputGroupContainer">
                                            <form:input path="receiptNumber" maxlength="100" id="receiptNumber"
                                ...
                                <spring:bind path="currentWage">
                                    <div class="form-group col-md-6 ${status.error ? 'has-danger' : ''}">
                                        <label class="form-control-label" for="currentWage">Current Wage</label>
                                        <div class="inputGroupContainer">
                        ...
                        <div class="card mb-4">
                            <div class="card-block">
                                <h3 class="card-title">Immigration Document Summary</h3>
